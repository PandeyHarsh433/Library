    ...
    >
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">
          Welcome to <span className="text-accent">Lumina</span>
        </h1>
      ...
      {/* About Section */}
      <div className="mb-16">
        <h2 className="text-3xl font-serif font-bold mb-8 text-center">About Lumina</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-cinematic-text/80">
              Lumina was created to democratize publishing and give voice to writers of all backgrounds. We believe every story deserves to be told and every voice deserves to be heard. Our platform bridges the gap between writers and readers, creating a vibrant community centered around the love of literature.
            </p>
          </div>
          <div>
            <h3 className="text-xl font-medium mb-4 flex items-center">
            ...
            <p className="text-cinematic-text/80">
              At the heart of Lumina is our diverse community of passionate readers, talented writers, and dedicated moderators. Together, we've created a space where literary works are celebrated, constructive feedback is offered, and meaningful connections are formed through the shared love of storytelling.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-cinematic-darker/20 p-6 rounded-lg border border-cinematic-gray/20">
            <p className="text-cinematic-text/80 italic mb-4">
              "Lumina has transformed my reading experience. I've discovered so many incredible books and authors I wouldn't have found otherwise. The community discussions add another dimension to my reading."
            </p>
          ...
          <div className="bg-cinematic-darker/20 p-6 rounded-lg border border-cinematic-gray/20">
            <p className="text-cinematic-text/80 italic mb-4">
              "As an independent writer, Lumina gave me a platform to share my stories and connect with readers from around the world. The feedback I've received has been invaluable to my growth as an author."
            </p>
            <div className="flex items-center">
      ...
      <div className="text-center bg-accent/10 p-8 rounded-lg border border-accent/20 mb-8">
        ...
        <p className="text-cinematic-text/80 max-w-2xl mx-auto mb-6">
          Join our growing community of readers and writers today. Whether you're here to discover your next favorite book or share your stories with the world, Lumina is the perfect place for you.
        </p>
        <div className="flex flex-wrap justify-center gap-4">
          <Button className="bg-accent text-cinematic-darker hover:bg-accent/90" asChild>
      ...
      <div className="mb-16">
        ...
        <div className="space-y-4">
          <div className="bg-cinematic-darker/30 p-6 rounded-lg border border-cinematic-gray/20">
            <h3 className="text-xl font-medium mb-2">Is Lumina free to use?</h3>
            <p className="text-cinematic-text/70">
              Yes, Lumina is completely free for both readers and writers. We believe in making literature accessible to everyone.
            </p>
          </div>

          <div className="bg-cinematic-darker/30 p-6 rounded-lg border border-cinematic-gray/20">
            <h3 className="text-xl font-medium mb-2">How do I become a writer on Lumina?</h3>
            <p className="text-cinematic-text/70">
          ...
          <div className="bg-cinematic-darker/30 p-6 rounded-lg border border-cinematic-gray/20">
            ...
            <p className="text-cinematic-text/70">
              Lumina welcomes all genres and styles of writing, but we maintain community guidelines to ensure content is appropriate. All submissions go through a moderation process.
            </p>
          </div>
          ...
          <div className="bg-cinematic-darker/30 p-6 rounded-lg border border-cinematic-gray/20">
            ...
            <p className="text-cinematic-text/70">
              Absolutely! Many authors use Lumina to build their audience and promote works published elsewhere. You can include links to purchase your books on other platforms.
            </p>
          </div>
        </div>
      </div>
